        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
              Desktop Application using .NET framework C#. To Enhance blur image that converts blur image into enhanced image.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
              Rental Management System is Web Application for manage rents and tenants and their bills payments and lease and ledger details. We have use ReactJS and NodeJS and MongoDB.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
